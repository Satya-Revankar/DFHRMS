...
public class Geofencing_Activity extends FragmentActivity implements
...
*/
        ...
        back_bt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                ...
                AlertDialog.Builder dialog = new AlertDialog.Builder(Geofencing_Activity.this);
    ...
    public void onMapReady(final GoogleMap googleMap)
    {
        ...
        gpstracker_obj1 = new GPSTracker(Geofencing_Activity.this);
...
//            task.execute();
            AsyncCall_getgeolocationinfo task = new AsyncCall_getgeolocationinfo(Geofencing_Activity.this);
            task.execute();
        } else {
